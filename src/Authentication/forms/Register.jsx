        ...
        <div className="my-10 p-4 card bg-base-100 w-full max-w-lg mx-auto shrink-0 shadow-2xl x">
            <div className="card-body">
                ...
                <p>have already an account?
                    <Link className='text-blue-800 underline text-sm' to='/authLayout/login'> Register</Link></p>
                ------------------------ or -----------------------
                {/* Google */}
                <button className="btn hover:bg-blue-400 hover:text-white bg-white text-black border-[#e5e5e5]">
